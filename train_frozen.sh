...
while true; do
    ...
    python -m ss_vq_vae.models.vqvae_oneshot --logdir=/mnt/vdb/model-leaky-relu-frozen-style-pretraining-29-10-2023/ --pretrained_style_encoder=/mnt/vdb/run-without-violin-bowed-27-10-2023/cola_305.pth train
