...
#     python -m ss_vq_vae.models.vqvae_oneshot --logdir=/mnt/vdb/model-leaky-relu-unfrozen-style-encoder-25-08-2023/ --pretrained_style_encoder=../COLA-PyTorch/run-25-07-2023/cola_306.pth --unfrozen_style_encoder --continue_training train
    ...
    python -m ss_vq_vae.models.vqvae_oneshot --logdir=/mnt/vdb/model-leaky-relu-finetuned-style-pretraining-29-08-2024/ --pretrained_style_encoder=/mnt/vdb/run-without-violin-bowed-27-10-2023/cola_305.pth --unfrozen_style_encoder train
