...
# while true; do
    ...
    COLA_VISIBLE_DEVICES=0 python -m ss_vq_vae.models.vqvae_oneshot --logdir=/mnt/vdc/model-leaky-relu-frozen-style-pretraining-30-08-2024/ --pretrained_style_encoder=/mnt/vdb/run-without-violin-bowed-27-10-2023/cola_305.pth train
